...
INSERT INTO BUSINESS_DEFINE(DEFINE_ID, NAME, CATEGORY_ID, _VERSION, PRIORITY, ENABLE, WF_VER,SUMMARY) VALUES('I1','测试业务1','I',1,1,true,1,'{"description":"送交单位{root.delver}"}');
INSERT INTO BUSINESS_DEFINE(DEFINE_ID, NAME, CATEGORY_ID, _VERSION, PRIORITY, ENABLE, WF_VER,SUMMARY) VALUES('I2','测试业务2','I',1,1,true,1,'{"description":"送交单位{root.delver}"}');
