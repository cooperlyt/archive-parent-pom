...
INSERT INTO CABINET(CABINET_ID,NAME,RACK_ID,SEQ,PERCENTAGE,ROW_DESC,COL_DESC) VALUES('A-1-1B','1B','A-1',1,10,true,false);
INSERT INTO CABINET(CABINET_ID,NAME,RACK_ID,SEQ,PERCENTAGE,ROW_DESC,COL_DESC) VALUES('A-1-2A','2A','A-1',2,0,true,true);
INSERT INTO CABINET(CABINET_ID,NAME,RACK_ID,SEQ,PERCENTAGE,ROW_DESC,COL_DESC) VALUES('A-1-2B','2B','A-1',3,0,true,false);
INSERT INTO CABINET(CABINET_ID,NAME,RACK_ID,SEQ,PERCENTAGE,ROW_DESC,COL_DESC) VALUES('A-1-3A','3A','A-1',4,0,true,true);
INSERT INTO CABINET(CABINET_ID,NAME,RACK_ID,SEQ,PERCENTAGE,ROW_DESC,COL_DESC) VALUES('A-1-3B','3B','A-1',5,0,true,false);
INSERT INTO CABINET(CABINET_ID,NAME,RACK_ID,SEQ,PERCENTAGE,ROW_DESC,COL_DESC) VALUES('A-1-4A','4A','A-1',6,0,true,true);
INSERT INTO CABINET(CABINET_ID,NAME,RACK_ID,SEQ,PERCENTAGE,ROW_DESC,COL_DESC) VALUES('A-1-4B','4B','A-1',7,0,true,false);
INSERT INTO CABINET(CABINET_ID,NAME,RACK_ID,SEQ,PERCENTAGE,ROW_DESC,COL_DESC) VALUES('A-1-5A','5A','A-1',8,0,true,true);
INSERT INTO CABINET(CABINET_ID,NAME,RACK_ID,SEQ,PERCENTAGE,ROW_DESC,COL_DESC) VALUES('A-1-5B','5B','A-1',9,0,true,false);
INSERT INTO CABINET(CABINET_ID,NAME,RACK_ID,SEQ,PERCENTAGE,ROW_DESC,COL_DESC) VALUES('A-1-6A','6A','A-1',10,0,true,true);
INSERT INTO CABINET(CABINET_ID,NAME,RACK_ID,SEQ,PERCENTAGE,ROW_DESC,COL_DESC) VALUES('A-1-6B','6B','A-1',11,0,true,false);
...
INSERT INTO CORP(CORP_ID, NAME, REG_ID_TYPE, REG_ID_NUMBER, OWNER_NAME, OWNER_ID_TYPE, OWNER_ID_NUMBER, ADDRESS, TEL, _VERSION, ENABLE, DATA_TIME)
    VALUES ('C1','测试建设单位1','COMPANY_CODE','0001','法人','OTHER','0001','地址','010',1,true, NOW());

INSERT INTO CONSTRUCT_CORP(REG_ID, CORP_TYPE, REG_DATE, STATUS, CORP_ID)
    VALUES('A1','CONSTRUCTION','2019-1-1' , 'NO','C1' );

INSERT INTO CORP(CORP_ID, NAME, REG_ID_TYPE, REG_ID_NUMBER, OWNER_NAME, OWNER_ID_TYPE, OWNER_ID_NUMBER, ADDRESS, TEL, _VERSION, ENABLE, DATA_TIME)
    VALUES ('C3','测试建设单位2','COMPANY_CODE','0002','法人','OTHER','0001','地址','010',1,true, NOW());

INSERT INTO CONSTRUCT_CORP(REG_ID, CORP_TYPE, REG_DATE, STATUS, CORP_ID)
    VALUES('A3','CONSTRUCTION','2019-1-1' , 'NO','C3' );

INSERT INTO CORP(CORP_ID, NAME, REG_ID_TYPE, REG_ID_NUMBER, OWNER_NAME, OWNER_ID_TYPE, OWNER_ID_NUMBER, ADDRESS, TEL, _VERSION, ENABLE, DATA_TIME)
    VALUES ('C4','测试建设单位3','COMPANY_CODE','0003','法人','OTHER','0001','地址','010',1,true, NOW());

INSERT INTO CONSTRUCT_CORP(REG_ID, CORP_TYPE, REG_DATE, STATUS, CORP_ID)
    VALUES('A4','CONSTRUCTION','2019-1-1' , 'NO','C4' );

INSERT INTO CORP(CORP_ID, NAME, REG_ID_TYPE, REG_ID_NUMBER, OWNER_NAME, OWNER_ID_TYPE, OWNER_ID_NUMBER, ADDRESS, TEL, _VERSION, ENABLE, DATA_TIME)
    VALUES ('C2','测试施工单位','COMPANY_CODE','0004','法人','OTHER','0001','地址','010',1,true, NOW());
