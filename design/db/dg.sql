...
INSERT INTO BUSINESS_DEFINE(DEFINE_ID, NAME, CATEGORY_ID, _VERSION, PRIORITY, ENABLE, WF_VER,SUMMARY,DEFAULT_ROOM, DEFAULT_RACK) VALUES('R.1.1','照片','R',1,1,true,1,'送交单位:{.deliver} 案卷题名:{.projectName}','3','3-1');
